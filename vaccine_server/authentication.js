...
const vaersDataStore = require('./VAERSDataStore');
    ...
    passport.use(
        new GoogleStrategy({
            ...
            async (accessToken, refreshToken, profile, callback) => {
                ...
                await vaersDataStore.userExists(profile);
...
exports.setupAuthentication = (app) => {
    ...
    const whitelist = (localOnly || localOnlyWithGoogleAuth) ? 'http://localhost:8080' : 'https://compsci290_2021spring.dukecs.io';
